...
int main(int argc, char **argv) {
  ...
  hPipe1 =
      CreateNamedPipe(TEXT("\\\\.\\pipe\\ffmpegVideoOne"), PIPE_ACCESS_OUTBOUND,
  ...
  hPipe2 =
      CreateNamedPipe(TEXT("\\\\.\\pipe\\ffmpegVideoTwo"), PIPE_ACCESS_OUTBOUND,
                      PIPE_TYPE_BYTE | PIPE_READMODE_BYTE | PIPE_WAIT,
                      PIPE_UNLIMITED_INSTANCES, // Max instances
                      1024 * 16,                // Out buffer size
                      1024 * 16,                // In buffer size
  ...
  hPipe3 =
      CreateNamedPipe(TEXT("\\\\.\\pipe\\terpTelemetry"), PIPE_ACCESS_OUTBOUND,
                      PIPE_TYPE_BYTE | PIPE_READMODE_BYTE | PIPE_WAIT,
                      PIPE_UNLIMITED_INSTANCES, // Max instances
