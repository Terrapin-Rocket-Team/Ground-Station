/**
 * NOTE: This will not work unless done in a similar fashioned manner to the Teensy-Based-Avionics
 * Ground Receiver code. Rather than specifics, the operations in the loop() call represent the 
 * generic multiplexing code needed, as well as how data is read from the serial port for commands.
 * 
*/
